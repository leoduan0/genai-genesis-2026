...
│                                                      │
│  Vertical chat layout (no sidebar — full-width chat) │
│                                                      │
│  Progress: Q 3 of ~25                                │
│  ░░░░░░░░░░░▓▓▓▓▓▓░░░░░░░░░░░░                      │
│                                                      │
...
│                                                      │
│  ┌─ LLM (left-aligned) ───────────────────────────┐  │
│  │ Q: Over the last 2 weeks, how often have you   │  │
│  │    been feeling down, depressed, or hopeless?   │  │
│  └─────────────────────────────────────────────────┘  │
│                                                      │
│           ┌─ Patient (right-aligned) ──────────────┐  │
│           │ A: 2/3 (More than half the days)       │  │
│           └────────────────────────────────────────┘  │
│                                                      │
│  ── Active item(s) ───────────────────────────────── │
│                                                      │
│  ┌─ LLM (left-aligned) ───────────────────────────┐  │
│  │ "Thank you for sharing that. I'd like to ask   │  │
│  │  about your sleep..."                           │  │
│  │                                                 │  │
│  │  ┌─ Screening Item (Likert) ─────────────────┐  │  │
│  │  │ Trouble falling or staying asleep, or      │  │  │
│  │  │ sleeping too much?                         │  │  │
│  │  │                                            │  │  │
│  │  │  Not at all  Several  More than  Nearly    │  │  │
│  │  │              days     half days   every day │  │  │
│  │  │  ┌───┐      ┌───┐    ┌───┐      ┌───┐     │  │  │
│  │  │  │ 0 │      │ 1 │    │ 2 │      │ 3 │     │  │  │
│  │  │  └───┘      └───┘    └───┘      └───┘     │  │  │
│  │  └────────────────────────────────────────────┘  │  │
│  │                                                 │  │
│  │  (LLM can include multiple items in one msg)    │  │
│  │                                                 │  │
│  │  ┌─ Screening Item (MCQ text) ───────────────┐  │  │
│  │  │ When you can't sleep, is it mostly:        │  │  │
│  │  │                                            │  │  │
│  │  │  ┌────────────────────────────────────┐    │  │  │
...
│  Once patient selects an answer:                     │
│  - LLM message compresses to "Q: <item text>"       │
│  - Patient answer becomes "A: <choice>" as a user    │
│    message bubble (right-aligned)                    │
│  - For Likert: "A: 2/3 (More than half the days)"   │
│  - For MCQ: "A: Trouble falling asleep"             │
│  - Multiple items in one LLM msg → each gets its    │
│    own Q:/A: pair after answering                    │
│                                                      │
│  Note: All boxes/bubbles/buttons use rounded edges   │
│  in the actual UI (rounded-lg / rounded-xl).         │
│                                                      │
│  ═══════════════════════════════════════════════════  │
...
├── MessageThread               — vertical chat scroll area
│   ├── AssistantMessage        — LLM text + embedded ScreeningItem(s)
│   │   └── ScreeningItem       — interactive item card (one or more per message)
│   │       ├── LikertScale     — row of label text + row of numbered bubbles below
│   │       └── McqChoices      — column of selectable text bubbles
│   ├── PatientMessage          — right-aligned user bubble ("A: choice")
│   └── CompressedExchange      — after answering: LLM msg → "Q: text", patient → "A: answer"
